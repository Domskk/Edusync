...
export default function StudyPlansPage() {
  ...
  // Daily streak logic (persists across sessions)
  function loadStreak() {
  ...
  function toggleDay(day: number) {
    ...
    const willCompletePlan = !wasCompleted && newSet.size + 1 === selectedPlan.content.schedule.length;
    ...
    // CONFETTI + POINTS WHEN PLAN IS 100% COMPLETED
    if (willCompletePlan) {
      confetti({
        particleCount: 300,
        spread: 100,
        origin: { y: 0.6 },
        colors: ['#ec4899', '#a855f7', '#8b5cf6', '#3b82f6', '#10b981'],
        scalar: 1.2,
      });
  ...
  // Award points to gamification table
